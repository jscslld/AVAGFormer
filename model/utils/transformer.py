...
class AVSTransformer(nn.Module):
    ...
    def encode(self, src, spatial_shapes, level_start_index, valid_ratios, pos=None, padding_mask=None):
        memory, reference_points = self.encoder(
            src, spatial_shapes, level_start_index, valid_ratios, pos, padding_mask)
        return memory,reference_points
    def decode(self, query, memory, reference_points, spatial_shapes, level_start_index, padding_mask=None):
